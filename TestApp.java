public class TestApp {
    public static void main(String[] args) {
        ...
        Person He = new Person ("John Smith");
        ...
        System.out.println("Is JANE registered in sofe2800: "+ String.valueOf(jane.isRegisteredInCourse(sofe2710)));

        System.out.println("Is JANE registered in mece 3000: "+ String.valueOf(jane.isRegisteredInCourse(sofe2800)));
